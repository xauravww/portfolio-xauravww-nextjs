...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <button
        className="h-10 w-10 fixed bottom-10 right-10 z-[20] border border-[#f3d800]/50 rounded-full bg-[#1A1D24]/60 backdrop-blur-md flex items-center justify-center transition-all hover:scale-110 hover:bg-[#f3d800]/20"
        onClick={() => scroll.scrollToTop()}
        aria-label="Scroll to top"
      >
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#f3d800]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
